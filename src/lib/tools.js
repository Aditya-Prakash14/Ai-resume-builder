...
export const suggestWorkExperienceTool = createTool({
  ...
  parameters: z.object({
    ...
    }).describe('Improved version of the work experience entry. For important keywords, format them: **keyword**. Put two asterisks around the keyword or phrase.'),
  }),
});
...
export const suggestProjectTool = createTool({
  ...
  parameters: z.object({
    ...
    }).describe('Improved version of the project entry. For important keywords, format them: **keyword**. Put two asterisks around the keyword or phrase.'),
  }),
});
...
export const suggestEducationTool = createTool({
  ...
  parameters: z.object({
    ...
    }).describe('Improved version of the education entry. For important keywords, format them: **keyword**. Put two asterisks around the keyword or phrase.'),
  }),
});

export const modifyWholeResumeTool = createTool({
  description: 'Modify multiple sections of the resume at once. For important keywords, format them: **keyword**. Put two asterisks around the keyword or phrase.',
  parameters: z.object({
    basic_info: z.object({
