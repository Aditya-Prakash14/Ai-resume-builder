...
import { initializeAIClient, 
      ...
      const { object } = await generateObject({
        ...
        prompt: `Please analyze this resume text and extract all relevant information into a structured profile format. 
                ...
                Ensure all arrays (like description, technologies, achievements) are properly formatted.
                For any missing or unclear information, use optional fields rather than making assumptions.
  
                Resume Text:
  ${userMessages}`,
        system: RESUME_FORMATTER_SYSTEM_MESSAGE.content;

  
    //   console.dir(object.content, { depth, colors);
